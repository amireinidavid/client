...
export default function FeaturedProductsPage() {
  const { allProducts, fetchAllProducts, updateFeaturedProducts } =
    useHomepageStore();
  ...
  // Initialize selected products with currently featured products
  useEffect(() => {
    const featuredProductIds = allProducts
  ...
  const handleSaveChanges = async () => {
    try {
      await updateFeaturedProducts(selectedProducts);
